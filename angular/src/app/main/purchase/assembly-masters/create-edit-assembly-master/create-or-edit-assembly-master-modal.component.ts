...
@Component({
    selector: 'create-edit-assembly-master-modal',
    templateUrl: './create-or-edit-assembly-master-modal.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['create-or-edit-assembly-master-modal.component.less']
})
export class CreateOrEditAssemblyMasterModalComponent extends AppComponentBase {
    @ViewChild('createOrEditModal', { static: true }) modal: ModalDirective;

    @Output() modalSave: EventEmitter<any> = new EventEmitter<any>();
    @Output() restoreAssemblyMaster: EventEmitter<ResponseDto> = new EventEmitter<ResponseDto>();
        ...
        this._assemblyService
            ...
            .subscribe((response : ResponseDto) => {
                if(!response.dataMatchFound){
                    ...
                    this.close();
                    this.restoreAssemblyMaster.emit(response);
                }
            });
    }
